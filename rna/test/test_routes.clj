...
;; (fact "About add-gene-name-to-query-results"
;;       (h/add-gene-name-to-query-results query-result mygene-in-local-db) => {"oo" "aa"})
...
(fact "About toptable-row-relevant-keys"
      (h/toptable-row-relevant-keys "eciivsd" (first toptable-results)) => [:eciivsd_p_value :eciivsd_aveexpr :eciivsd_b :eciivsd_adj_p_val :eciivsd_t :eciivsd_logfc])

(fact "About toptable-relevant-items"
      (h/toptable-relevant-items "eciivsd" toptable-results) => [{:eciivsd_adj_p_val 8.67177E-5, :eciivsd_aveexpr 11.3112, :eciivsd_b 1.67929, :eciivsd_logfc -0.246011, :eciivsd_p_value 1.52756E-5, :eciivsd_t -4.788} {:eciivsd_adj_p_val 0.0904392, :eciivsd_aveexpr 5.19365, :eciivsd_b -5.66063, :eciivsd_logfc 0.141275, :eciivsd_p_value 0.0433745, :eciivsd_t 2.07247} {:eciivsd_adj_p_val 0.262847, :eciivsd_aveexpr 6.11175, :eciivsd_b -6.83566, :eciivsd_logfc 0.0514366, :eciivsd_p_value 0.158953, :eciivsd_t 1.42985}])

(def tt-relevant-items-result [{:eciivsd_adj_p_val 8.67177E-5, :eciivsd_aveexpr 11.3112, :eciivsd_b 1.67929, :eciivsd_logfc -0.246011, :eciivsd_p_value 1.52756E-5, :eciivsd_t -4.788} {:eciivsd_adj_p_val 0.0904392, :eciivsd_aveexpr 5.19365, :eciivsd_b -5.66063, :eciivsd_logfc 0.141275, :eciivsd_p_value 0.0433745, :eciivsd_t 2.07247} {:eciivsd_adj_p_val 0.262847, :eciivsd_aveexpr 6.11175, :eciivsd_b -6.83566, :eciivsd_logfc 0.0514366, :eciivsd_p_value 0.158953, :eciivsd_t 1.42985}])

(fact "About toptable-rename-items"
      (h/toptable-rename-items "eciivsd" tt-relevant-items-result) => nil)
